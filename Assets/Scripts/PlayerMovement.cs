...
public class PlayerMovement : MonoBehaviour
{
    ...
    //temp values
    public float wallRunForce = 3000, maxWallRunTime = 2 , maxWallSpeed = 30;
    bool isWallRight, isWallLeft;
    bool isWallRunning;
    public float maxWallRunCameraTilt = 25, wallRunCameraTilt;

    private void wallRunInput(){
        if ((Input.GetKey(KeyCode.RightArrow)) && isWallRight) startWallRun();
        if ((Input.GetKey(KeyCode.LeftArrow)) && isWallLeft) startWallRun();
